...
import com.dounine.ecdouyin.behaviors.mechine.status.ScannedStatus.logger
...
object WechatPageStatus extends JsonParse {

  private final val logger: Logger =
    LoggerFactory.getLogger(WechatPageStatus.getClass)
