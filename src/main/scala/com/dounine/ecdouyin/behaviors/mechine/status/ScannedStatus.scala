...
object ScannedStatus extends JsonParse {

  private final val logger: Logger =
    LoggerFactory.getLogger(ScannedStatus.getClass)
  ...
  def apply(
    ...
    (commandHandler, defaultEvent, classOf[Scanned], MechineStatus.scanned)
  }
}
